...
const MAYDAN_ALT_AR = [
  'الميدان — الصفحة الرئيسية والبحث عن الفعاليات وأبرز العروض',
  'الميدان — تأكيد الحجز وتفاصيل الطلب والتذاكر الرقمية',
  'الميدان — إتمام الدفع وملخص الطلب ومعلومات المشتري',
  'الميدان — تذكرة العرض والعد التنازلي وتنزيل التذكرة',
  'الميدان — تحليل التذاكر والمبيعات وقنوات البيع',
  'الميدان — الكفاءة التشغيلية والكوادر وخريطة حرارة الكثافة',
  'الميدان — صحة الأصول (IoT) والصيانة الوقائية',
  'الميدان — الأمن وسجل المخالفات والغرامات',
  'الميدان — مركز القيادة اللحظي والتحكم السريع',
  'الميدان — لوحة القيادة المركزية وتحليل الإيرادات عبر الزمن',
  'الميدان — مركز قرارات الذكاء الاصطناعي والتوصيات الاستراتيجية',
  'الميدان — استكشاف التصنيفات وعن المنصة',
  'الميدان — الإدارة المالية والميزانية مقابل الفعلي وتحليل التعادل',
] as const

const maydanGalleryAr: ProjectGalleryImage[] = MAYDAN_ALT_AR.map((alt, i) => ({
  src: `/projects/maydan/slide-${String(i + 1).padStart(2, '0')}.png`,
  alt,
}))

const MIDHAL_ALT_AR = [
  'مدهال — الصفحة الرئيسية وتوثيق التراث السعودي وأزرار الاستكشاف',
  'مدهال — الهيرو والتنقل وقسم اكتشف تراثنا',
  'مدهال — بطاقات التراث: الحكم والأمثال، الأنثروبولوجيا، الميثولوجيا، والأبيات الشعرية',
  'مدهال — القصايد الشعبية وبطاقة الطنّانة',
  'مدهال — نافذة تفصيلية لسيرة تاريخية مع صورة ونص أرشيفي',
  'مدهال — الخريطة التفاعلية (Leaflet) وعلامة موقع غار الإمام تركي',
] as const

const midhalGalleryAr: ProjectGalleryImage[] = MIDHAL_ALT_AR.map((alt, i) => ({
  src: `/projects/midhal/slide-${String(i + 1).padStart(2, '0')}.png`,
  alt,
}))

const MEDINMIND_ALT_AR = [
  'MedinMind Ai — شريحة عنوان المشروع (تخصيص موارد طبية طارئة) مع سدايا أذكى وجامعة تبوك وAzure',
  'الأهداف — كفاءة الاستجابة الطارئة وتخصيص الموارد وتقليل زمن الحالات الحرجة',
  'التقنيات المستخدمة — Azure AI Services، Azure Database، Speech Services',
  'تحليل ما قبل النموذج — زمن حضري وريفي ومعدلات استخدام وذروة وخمول',
  'تحليل ما بعد النموذج — مقارنة المؤشرات بعد التدريب',
  'النتائج — بقاء، رضا مرضى، تخصيص موارد ديناميكي، وتقليل مسافة التنقل',
  'نموذج العمل — مشكلة، حل، قيمة فريدة، مقاييس، وقنوات (Lean Canvas)',
  'لوحة Dispatcher — خريطة ومسار إسعاف محسّن وملخص المسافة والزمن',
] as const

const medinmindGalleryAr: ProjectGalleryImage[] = MEDINMIND_ALT_AR.map((alt, i) => ({
...
export const projects: ProjectEntry[] = [
  ...
  },
  {
    ...
    detail:
      '**الميدان** يجمع **تجربة حجز للجمهور** (استكشاف فعاليات، بحث، دفع، تأكيد، تذكرة رقمية) مع **مركز قيادة تنفيذي** بلوحات مبيعات ومالية وأمن و**صحة أصول IoT** وكفاءة تشغيلية و**مركز قرارات بالذكاء الاصطناعي**. اللقطات أدناه من واجهات التصميم للمشروع.',
    tags: ['SaaS', 'تحليلات', 'سحابة'],
    href: '#',
    coverSrc: '/projects/maydan/cover.png',
    gallery: maydanGalleryAr,
  },
  {
  ...
  },
  {
    ...
    detail:
      '**مدهال** واجهة ويب عربية (RTL) لتوثيق التراث: **صفحة رئيسية**، **استكشاف تراث** بتصنيفات (حكم وأمثال، أنثروبولوجيا، ميثولوجيا، شعر)، **قصائد شعبية** مع بطاقات و**نافذة تفصيل** لسير ذاتية، و**خريطة تفاعلية** بـ Leaflet/OpenStreetMap لمواقع تاريخية. اللقطات من تصميم الواجهات.',
    tags: ['أرشفة', 'تراث', 'ويب'],
    href: '#',
    coverSrc: '/projects/midhal/cover.png',
    gallery: midhalGalleryAr,
  },
  {
    ...
    detail:
      'مشروع **MedinMind Ai** ضمن **هاكاثون سدايا أذكى — Athka U**: تخصيص ديناميكي لموارد الطوارئ مع **Azure AI** و**Azure Maps** وتحليلات قبل/بعد النموذج، ولوحة **Dispatcher** لمسار الإسعاف والمستشفى. اللقطات من عرض المشروع وواجهة النموذج الأولي.',
    tags: ['توجيه', 'تحسين', 'Azure'],
    href: '#',
    coverSrc: '/projects/medinmind/cover.png',
    gallery: medinmindGalleryAr,
  },
]
