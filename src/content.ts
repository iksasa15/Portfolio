...
export const projects = [
  ...
  },
  {
    ...
    summary:
      'بفضل الله، **المركز الثاني** على منصّة التتويج في **هاكاثون الابتكار في البيانات** بتنظيم **الهيئة العامة للإحصاء** وسط منافسة ضمّت **١٣٢ فريقاً**. **عين** منصّة ذكية لرفع جودة البيانات من المصدر: تدمج **الذكاء الاصطناعي** و**نماذج اللغة الكبيرة** مع **قواعد الأعمال** لكشف التناقضات المنطقية والدلالية؛ **استمارات حيّة** تحلّل الإدخال فوراً مع تنبيه و**درجة ثقة** لكل سجل؛ ورفع **Excel / CSV** لمسح السجلات واكتشاف التضارب بين الحقول — يحوّل التحقق من «مرحلة لاحقة» إلى «جزء مباشر» من دورة العمل.',
