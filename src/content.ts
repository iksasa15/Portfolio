/** عدّل هالمحتوى على كيفك — نصوص بالعامية */
...
export const site = {
  ...
  tagline:
    'أسوّي أنظمة ذكاء اصطناعي وتنزل للإنتاج: أشبك موديلات لغوية كبيرة، أشتغل رؤية حاسوبية، وألقّم أتمتة على البيانات.',
...
export const education: EducationEntry[] = [
  ...
  },
  {
    ...
    highlights: [
      'مشيت مع دورة حياة البيانات من أول ما تنجمع لين ما نشرنا معماريات التعلم العميق.',
      'سويت حلول مستقلة مبنية على موديلات لغوية كبيرة، وحسّنت تدفّق البيانات عشان أتمتة المهام على نطاق واسع.',
      'شبّكت موديلات ذكاء اصطناعي معقدة في تطبيقات عن طريق REST، مع انتباه لصحة البيانات وثباتها.',
    ],
  },
]

export const aboutParagraphs = [
  'أنا أحمد الحربي، مهندس ذكاء اصطناعي، متخرّج بكالوريوس علوم حاسب ومعدلي ٤٫٥٠ من ٥ (تخرّجت ٢٠٢٥). أشتغل تصميم وبناء ونشر أنظمة ذكاء اصطناعي جاهزة للإنتاج، ومركز على تكامل الموديلات اللغوية الكبيرة، مسارات الرؤية الحاسوبية، والأتمتة اللي تقوم على البيانات؛ وأحوّل اللي يبونه في الشغل إلى منتج يتوسّع ويثبت.',
...
export const projects = [
  ...
  },
  {
    ...
    badge: 'تجربة',
    summary: 'مسارات تعلم، تتبّع تقدّم، وتصميم متجاوب يمشي على كل الشاشات.',
    tags: ['PWA', 'A11y'],
    href: '#',
  },
]
