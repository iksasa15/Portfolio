...
export const volunteering: JourneyEntry[] = [
  ...
  },
  {
    ...
    org: 'نادي قوقل للطلاب المطورين — جامعة تبوك',
    summary:
      'دعم رئيس اللجنة في التخطيط والتنفيذ؛ ورش مثل تطوير اللغة الإنجليزية وتحدي فيجوال ٢٣؛ تصميم إعلانات ومحتوى (مثل نادي السياحة).',
  },
  {
    range: '١٤٤٤ — ١٤٤٥ هـ',
...
export const projects = [
  ...
  },
  {
    ...
    summary:
      '**المركز الثاني** على منصّة التتويج في **هاكاثون الابتكار في البيانات** بتنظيم **الهيئة العامة للإحصاء** وسط منافسة ضمّت **١٣٢ فريقاً**. الفكرة: **عين** ترفع جودة البيانات من المصدر بدمج **الذكاء الاصطناعي** و**نماذج اللغة الكبيرة** مع **قواعد الأعمال** للتحقق أثناء الإدخال بدل تأجيله لمرحلة لاحقة.',
