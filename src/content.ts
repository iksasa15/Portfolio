...
export const aboutParagraphs = [
  ...
  '**خبراتي التدريبية والأكاديمية:** تدريب في **وزارة الصحة** على مسارات التصوير الطبي والسجلات؛ وزمالة تخصّص ذكاء اصطناعي في **كاوست**؛ و**معسكر علوم البيانات والذكاء الاصطناعي** في **أكاديمية طويق**.',
]
