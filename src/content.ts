...
export const aboutParagraphs = [
  'أنا أحمد الحربي، مهندس ذكاء اصطناعي، متخرّج بكالوريوس علوم حاسب من جامعة تبوك — معدّلي ٤٫٥٠ من ٥ (٢٠٢٥). أبني وأنشر أنظمة ذكاء اصطناعي للإنتاج: موديلات لغوية كبيرة، رؤية حاسوبية، وأتمتة مبنية على البيانات.',
  'تدريب في وزارة الصحة على مسارات التصوير الطبي والسجلات؛ وزمالة تخصّص ذكاء اصطناعي في كاوست، ومعسكر علوم البيانات والذكاء الاصطناعي في أكاديمية طويق. من مشاريعي على أرض الواقع: منصة NextEd، معين (ذكاء القضاء)، نداء للطوارئ، وأتقنها للعلاج الطبيعي — ومعها شغل في أمن وبيانات وهاكاثونات. قيسناه: تحسين مكاني ببايثون خفّض زمن استجابة API تقريباً ٧٥–٨٥٪ في سيناريو حقيقي.',
]
